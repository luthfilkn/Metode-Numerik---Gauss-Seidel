document.getElementById("generateMatrix").addEventListener("click", function () {
    ...
    for (let i = 0; i < size; i++) {    
        ...
        for (let j = 0; j <= size; j++) {
            ...
            input.placeholder = j === size ? "Sumber Aliran" : `Hubungan Aliran[${i + 1},${j + 1}]`;
    ...
    for (let i = 0; i < size; i++) {
        ...
        input.type = "number";
        input.step = "0.01";
        input.placeholder = `Nilai Awal x[${i + 1}]`;
...
document.getElementById("calculate").addEventListener("click", function () {
    ...
    // Add table header
    let headerRow = "<tr><th>Siklus</th>";
    for (let i = 0; i < size; i++) {
        headerRow += `<th>Aliran[${i + 1}]</th>`;
    }
    headerRow += "<th>Rumus Perhitungan Siklus</th></tr>";
    resultsTable.innerHTML += headerRow;

    // Tabel untuk nilai error
    const errorTable = document.getElementById("errorTable");
    errorTable.innerHTML = "<tr><th>Siklus</th><th>Deviasi Aliran 1</th><th>Rumus Deviasi Aliran 1</th><th>Deviasi Aliran 2</th><th>Rumus Deviasi Aliran 2</th><th>Deviasi Aliran 3</th><th>Rumus Deviasi Aliran 3</th>";
